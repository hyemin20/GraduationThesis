...
lavOptions(x = out_5_2, default = NULL, mimic = "lavaan", bounds = "pos.var")
lavOptions(bounds = "pos.var")
#graphic
...
out_7 <- sem(sem_model_7, df_na_a)
fitMeasures(out_7 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_7, fit.measures=T, standardized=T, rsquare=T)
...
out_8 <- sem(sem_model_8, df_na_b)
fitMeasures(out_8 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_8, fit.measures=T, standardized=T, rsquare=T)
...
out_9 <- sem(sem_model_9, df_na_b)
fitMeasures(out_9 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_9, fit.measures=T, standardized=T, rsquare=T)
...
fitMeasures(out_10 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_10, fit.measures=T, standardized=T, rsquare=T)
...
fitMeasures(out_11 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_11, fit.measures=T, standardized=T, rsquare=T)




### GPA_norm together_depends which PersonalRelationship
sem_model_12 <-
  'AcademicR =~ Resili_SelfEffi + Resili_SituJuge + Resili_Resource + Resili_Vital + Resili_FutureOrien
...
fitMeasures(out_12 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_12, fit.measures=T, standardized=T, rsquare=T)
...
### UnivSatis, GPA_norm together_depends which PersonalRelationship
sem_model_9 <-
  'R_friend =~ R_friend_famil + R_friend_credit + R_friend_respect
  R_prof =~ R_prof_famil + R_prof_credit + R_prof_respect
  R_parent =~ R_parent_famil + R_parent_credit + R_parent_respect
...
out_11 <- sem(sem_model_11, df_na_a)
fitMeasures(out_11 ,c("chisq","df","pvalue","cfi","tli","rmsea","rmsea.ci.lower","rmsea.ci.upper","rmsea.pvalue","srmr")) %>%
  kable (format="pandoc",caption = "Model fit information")
summary(out_11, fit.measures=T, standardized=T, rsquare=T)
